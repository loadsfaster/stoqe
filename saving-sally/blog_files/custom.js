	...
	$(document).ready( function(){
		...
		$( window ).ready( function(){
			if ( $.fn.fitVids ) {
				...
				$( '#main-content' ).fitVids( { customSelector: "iframe[src^='https://web.archive.org/web/20180318072106/http://www.hulu.com/'], iframe[src^='https://web.archive.org/web/20180318072106/http://www.dailymotion.com/'], iframe[src^='https://web.archive.org/web/20180318072106/http://www.funnyordie.com/'], iframe[src^='https://web.archive.org/web/20180318072106/https://embed-ssl.ted.com/'], iframe[src^='https://web.archive.org/web/20180318072106/http://embed.revision3.com/'], iframe[src^='https://web.archive.org/web/20180318072106/https://flickr.com/'], iframe[src^='https://web.archive.org/web/20180318072106/http://blip.tv/'], iframe[src^='https://web.archive.org/web/20180318072106/http://www.collegehumor.com/']"} );
			}
...
/*
     FILE ARCHIVED ON 07:21:06 Mar 18, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 02:42:07 Jun 24, 2019.
...
/*
playback timings (ms):
  LoadShardBlock: 79.711 (3)
  esindex: 0.008
  captures_list: 128.258
  CDXLines.iter: 15.541 (3)
  PetaboxLoader3.datanode: 59.834 (4)
  exclusion.robots: 0.283
  exclusion.robots.policy: 0.264
  RedisCDXSource: 29.109
  PetaboxLoader3.resolve: 56.469 (2)
  load_resource: 72.344
*/