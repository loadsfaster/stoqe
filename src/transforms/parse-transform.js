  ...
  if (outputPath.endsWith('.html')) {
    ...
    if (articleHeadings.length) {
      ...
      articleHeadings.forEach(heading => {
        ...
        <span role="text" class="hidden"> permalink</span>
        <svg class="inline h-6 w-6 ml-3 text-red" fill="currentColor" aria-hidden="true" focusable="false" width="" height="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
