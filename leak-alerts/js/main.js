      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          ...
          if (xhttpresponse.indexOf(subsha1pass) !== -1) {
            ...
            document.getElementById("iscompromised").innerHTML = '<div class="mb0 brv0 notification is-danger is-size-5"><strong>YES THIS PASSWORD HAS BEEN LEAKED ONLINE</strong><br><br><span class="icon"><i class="fas fa-exclamation-triangle"></i></span>&nbsp; At least <strong>'+ pwnedcount + ' accounts</strong> using this password <strong>have been leaked online</strong><br><span class="icon"><i class="fas fa-exclamation-triangle"></i></span>&nbsp; <strong>Nb:</strong> There <strong>might be more</strong> than '+ pwnedcount + '<!-- leaked accounts--><br><span class="icon"><i class="fas fa-exclamation-triangle"></i></span>&nbsp; This password has been leaked online <strong>with usernames + login addresses</strong><br><span class="icon"><i class="fas fa-exclamation-triangle"></i></span>&nbsp; <strong>Full access to accounts</strong> using this password have leaked online<br><span class="icon"><i class="fas fa-question-circle"></i></span>&nbsp; Are you using <strong>the same password for different accounts?</strong> <br><span class="icon"><i class="fas fa-question-circle"></i></span>&nbsp; If so, <strong>how many accounts does this password login to?</strong><br><span class="icon"><i class="fas fa-exclamation-triangle"></i></span>&nbsp; Because <strong>they\'re all compromised</strong> if even 1 of the leaked accounts is yours<!--br><span class="icon"><i class="fas fa-question-circle"></i></span>&nbsp; And <strong>how many of these leaked '+ pwnedcount + ' accounts could belong to you?</strong--><!--br><span class="icon"><i class="fas fa-question-circle"></i></span>&nbsp; <strong>Can this password login to</strong> your banking, email, website, social media, etc.?--></div><div class="brt0 notification is-warning is-size-5"><span class="icon"><i class="fas fa-exclamation-circle"></i></span>&nbsp; <strong>STATUS</strong>: This password is <strong>CRITICALLY COMPROMISED</strong><!-- Want help? STOQE can save you.--><div>';
          }else {
            lastrequestfinished = true;
            document.getElementById("iscompromised").innerHTML = '<div class="brt0 notification is-success is-size-5"><span class="icon"><i class="fas fa-shield-check"></i></span>&nbsp; <strong>Good news!</strong> This password has never <span class="is-italic">knowingly</span> been leaked online<strong><div>';
          }
        }else {
