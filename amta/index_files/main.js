    ...
    var lastestTweets = function() {
        if ( $().tweet ) {
            $('.latest-tweets').each(function() {
                ...
                $this.tweet({
                    username: $this.data('@Austmobiles'),
                    join_text: "auto",
                    avatar_size: null,
                    count: $this.data('4'),
                    template: "{text}{time}",
        ...
        menuWidthDetect: function(winWidth) {
            ...
            if ( currMenuType !== responsiveMenu.menuType ) {
                ...
                if ( currMenuType === 'mobile' ) {
                    ...
                    $('#mainnav-mobi').children('.menu').prepend('<li class="added menu-addon"><span class="signup-link"><a href="/join">Join AMTA</a></span></li>');
                    $('#mainnav-mobi').children('.menu').append('<li class="added"><div id="search-form-menu"><form action="/sitesearch" method="get"><input name="q" type="text" class="search-text-menu" id="search-text-menu"></form></div><div class="social-mobi"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div></li>');
